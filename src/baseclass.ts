...
/* "This class represents a computer, and it has
properties that represent the name, service tag, version, domain, current user, and assigned HID of
the computer." */
 ...
 * @param {string} domain - The domain the computer is on
 * @param {string} currUser - The current user of the computer
 * @param {HID} assignedHID - HID
 */
